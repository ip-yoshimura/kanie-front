...
<div class="col-xs-8 col-md-10 no-padding body-background">
    ...
    <div class="col-md-12 col-xs-12 no-padding">
        ...
        <form action="/gas/meter-reading" id="meter" method="POST">
			...
			<div class="col-xs-3">
			    <div class="form-group">
				<input id="supplierText" name="supplierText" placeholder="忠燃高圧ガス" class="form-control"
				    type="text" value="忠燃高圧ガス" onchange="$.fn.onInputValueChange('consumerCodeStart', 'consumerCodeStartName')"/>
			    </div>
			</div>
                    </div>
                </div>
