    ...
    <div class="col-md-12 col-xs-12 no-padding body-background">
            ...
            <form action="/gas/meter-reading" id="meter" method="POST">
                <div class="col-xs-12 border1 no-padding">
                    ...
                    <div class="col-xs-12">
                        <div class="col-xs-12 no-padding">
                            ...
                            <div class="col-xs-1">
                                <input name="TrustClassification" type="radio" value="directSales" onclick="$.fn.radioButtonSelectionChanged('TrustClassification', 'TrustClassificationId')"> <span> 直売</span>
                            </div>
                            <div class="col-xs-2">
			    ...
			    <div class="col-xs-9">
                            ...
                            <div class="col-xs-2">
                                <input name="OutputDifferentiation" type="radio" value="salesOutlet" onclick="$.fn.radioButtonSelectionChanged('OutputDifferentiation', 'OutputDifferentiationId')"> <span>集金担当者</span>
                            </div>
                            <div class="col-xs-2">
                ...
                <div class="col-xs-12 border1 no-padding bottom-box">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-1 no-padding">
                            <div class="form-group">
                                <input class="form-control" id="trustStartId" name="trustStartId" placeholder="0"
                                       type="number" value=""/>
                            </div>
                        </div>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="col-xs-1 no-padding ml-n-50">
                            <div class="form-group">
