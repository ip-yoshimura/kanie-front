        ...
        <form id="meter" action="/gas/meter-reading" method="POST">
            <div class="col-xs-12 no-padding">
                ...
                <div class="form-group">
                    <label class="col-xs-1  no-padding mt-2"><p>消費設備区分</p>  </label>
                    <div class="col-xs-1 no-padding">
                        <input type="radio" name="municipality" id="municipality" value="all" onclick="$.fn.radioButtonSelectionChanged('municipality', 'municipalityId')"/> <span>  燃焼器具</span>
                    </div>
                    <div class="col-xs-1 no-padding">
                        <input type="radio" name="municipality" id="municipality" value="all" onclick="$.fn.radioButtonSelectionChanged('municipality', 'municipalityId')"/> <span>  消費設備配管</span>
                    </div>
                    <div class="col-xs-1 no-padding ml-15">
                        <input type="radio" name="municipality" id="municipality" value="all" onclick="$.fn.radioButtonSelectionChanged('municipality', 'municipalityId')"/> <span>  末端ガス栓</span>
                    </div>
                    <div class="col-xs-1 no-padding">
                        <input type="radio" name="municipality" id="municipality" value="all" onclick="$.fn.radioButtonSelectionChanged('municipality', 'municipalityId')"/> <span>  接続具</span>
                    </div>
            ...
            <div class="col-xs-8 bottom-box no-padding tbl-scroll">
                ...
                <table class="table table-bordered col-xs-12">
                    ...
                    <tr>
                        ...
                        <th class="td-style col-xs-3">種別名</th>
