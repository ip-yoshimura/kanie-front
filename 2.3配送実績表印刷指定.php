                ...
                <div class="col-xs-12 border1 no-padding">
                    ...
                    <div class="col-xs-12 ">
                        <div class="col-xs-12 no-padding">
                            ...
                            <div class="col-xs-1">
                                <input type="radio" name="trustSelection" id="trustSelection" value="directSales" onclick="$.fn.radioButtonSelectionChanged('trustSelection', 'trustSelectionId')"> 直売
                            </div>
                            <div class="col-xs-2">
                                <input type="radio" name="trustSelection" id="trustSelection" value="salesOutlet" onclick="$.fn.radioButtonSelectionChanged('trustSelection', 'trustSelectionId')"> 販売店
                            </div>
                        </div>
