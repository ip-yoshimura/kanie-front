            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <div class="col-xs-2">
                                <input type="radio" name="targetLaw" value="all" onclick="$.fn.radioButtonSelectionChanged('contaitargetLawner', 'targetLawId')"/>液石法   
                            </div>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        <label class="col-xs-1 no-padding">供給形態
                        </label>
                        <div class="col-xs-10">
                            <div class="col-xs-2">
