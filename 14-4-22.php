            ...
            <p>バルク貯槽管理票印刷指定</p>
                ...
                <form action="/gas/meter-reading" id="meter" method="POST">
                    ...
                    <div class="col-xs-12 border1 no-padding">
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                <label class="col-xs-1 no-padding">経過年数</label>
				...
				<div class="col-xs-1 no-padding">
                                    <input id="consumerCodeStart" name="consumerCodeStart" placeholder="0"
                                    class="form-control" type="number" value="" onchange="$.fn.onInputValueChange('consumerCodeStart', 'consumerCodeStartName')"/>
				</div>
                                <label class="col-xs-1 no-padding">年以上</label>
                                <label class="col-xs-1 no-padding">年数不明</label>
                                <div class="col-xs-1 no-padding">
				...
				<div class="col-xs-4 no-padding">
                                    <label class="col-xs-3 no-padding">設置年月</label>
                                    <div class="col-xs-4 form-group">
                                        <input class="form-control" id="settingStartId" name="settingStartId" type="date" value="" onchange="$.fn.onInputValueChange('settingStartId', 'settingStartName')"/>
                                    </div>
                                    <div class="col-xs-1 no-padding ratio">~</div>
                                    <div class="col-xs-4">
					<input class="form-control" id="settingStartName" name="settingStartName" type="date" value=""/>
                                    </div>
				</div>
				<div class="col-xs-4 no-padding">
				    <label class="col-xs-3 no-padding">製造年月</label>
				    <div class="col-xs-4 form-group">
					<input class="form-control" id="manufacturingDateStartId" name="manufacturingDateStartId" type="date" value="" onchange="$.fn.onInputValueChange('manufacturingDateStartId', 'manufacturingDateStartName')"/>
				    </div>
                                    <div class="col-xs-1 no-padding ratio">~</div>
				    <div class="col-xs-4 form-group">
					<input class="form-control" id="manufacturingDateStartName" name="manufacturingDateStartName" type="date" value=""/>
				    </div>
				</div>
				<div class="col-xs-4 no-padding">
				    <label class="col-xs-3 no-padding">安全弁交換年月</label>
				    <div class="col-xs-4">
					<div class="form-group">
					    <input class="form-control" id="safetyStartId" name="safetyStartId"
						   type="date" value="" onchange="$.fn.onInputValueChange('safetyStartId', 'safetyStartName')"/>
					</div>
				    </div>
				    <div class="col-xs-1 no-padding ratio">~</div>
				    <div class="col-xs-4">
					<div class="form-group">
					    <input class="form-control" id="safetyStartName" name="safetyStartName" type="date" value=""/>
					</div>
				    </div>
				</div>
			    </div>
