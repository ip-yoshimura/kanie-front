                    ...
                    <form id="meter" action="/gas/meter-reading" method="POST">
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-12 no-padding">
                                ...
                                <div class="col-xs-1">
                                    <input type="radio" name="lable" value="all" onclick="$.fn.radioButtonSelectionChanged('lable', 'lableId')"> <span>全て</span>
                                </div>
                                <div class="col-xs-1 no-padding">
                                ...
                                <div class="col-xs-1 col-xs-offset-1">
                                    <div class="form-group">
                                        <input id="outputStartId" name="outputStartId" placeholder="000" class="form-control"
                                            type="text" value="" onchange="$.fn.onInputValueChange('outputStartId', 'outputStartName')"/>
                                    </div>
                                </div>
                                <div class="col-xs-1 no-padding ratio">~</div>
                                <div class="col-xs-1">
                                    <div class="form-group">
                                        <input id="outputEndId" name="outputEndId" placeholder="999" class="form-control"
                                            type="text" value="" onchange="$.fn.onInputValueChange('outputEndId', 'outputEndName')"/>
                                    </div>
                                </div>
                                <div class="col-xs-3">
                                    <div class="form-group">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-10">
                                <div class="col-xs-1 no-padding"><input type="radio" id="" name="status" value="all" onclick="$.fn.radioButtonSelectionChanged('status', 'statusId')"><span> 全て</span></div>
                                <div class="col-xs-2 no-padding"><input type="radio" id="" name="status" value="status" onclick="$.fn.radioButtonSelectionChanged('status', 'statusId')"><span> 閉栓・休止除く</span></div>
                                <div class="col-xs-2 no-padding"><input type="radio" id="" name="status" value="status" onclick="$.fn.radioButtonSelectionChanged('status', 'statusId')"><span> 閉栓・休止除く</span></div>
                        ...
                        <div class="col-xs-12" style="margin-top:8px;">
                            ...
                            <div class="col-xs-2 no-padding">
                                <div class="col-xs-6 no-padding"><input type="radio" id="" name="business" value="all" onclick="$.fn.radioButtonSelectionChanged('business', 'businessId')"><span> 全て</span></div>
                                <div class="col-xs-6 no-padding"><input type="radio" id="" name="business" value="business" onclick="$.fn.radioButtonSelectionChanged('business', 'businessId')"><span> 選択</span></div>
                            ...
                            <p class="backend">
                                ...
                                <div class="col-xs-12 border-margin-bottom" >
                                    ...
                                    <div class="col-xs-1">
                                        ...
                                        <div class="col-xs-1">
                                            <input type="text" class="form-control" placeholder="999" id="investigator_3Id" name="investigator_3Id" 
