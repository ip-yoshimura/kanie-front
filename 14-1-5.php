        ...
        <form id="meter" action="/gas/meter-reading" method="POST">
                    ...
                    <div class="col-xs-12 ">
                        ...
                        <div class="col-xs-1">
                            <input type="radio" name="otherCompany" value="directSales"
                                   onclick="$.fn.radioButtonSelectionChanged('otherCompany', 'otherCompanyId')"> <span> 自社</span>
                        </div>
                        <div class="col-xs-2">
                            <input type="radio" name="otherCompany" value="salesOutlet"
                                   onclick="$.fn.radioButtonSelectionChanged('otherCompany', 'otherCompanyId')"> <span> 他社</span>
                        </div>
                    </div>
            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="col-xs-12 border-margin">
                    ...
                    <div class="col-xs-2">
                        <div class="col-xs-6 no-padding"><input type="radio" id="" name="meter" value="all"
                                                                onclick="$.fn.radioButtonSelectionChanged('meter', 'meterId')"><span> しない</span>
                        </div>
                        <div class="col-xs-6 no-padding"><input type="radio" id="" name="meter" value="custom"
                                                                onclick="$.fn.radioButtonSelectionChanged('meter', 'meterId')"><span> する</span>
                        </div>
                ...
                <div class="col-xs-12 border-margin">
                    ...
                    <div class="col-xs-5">
                        <div class="col-xs-2 no-padding"><input type="radio" id="" name="targetLow" value="all"
                                                                onclick="$.fn.radioButtonSelectionChanged('targetLow', 'targetLowId')"><span> 全て</span>
                        </div>
                        <div class="col-xs-2 no-padding"><input type="radio" id="" name="targetLow" value="targetLow"
                                                                onclick="$.fn.radioButtonSelectionChanged('targetLow', 'targetLowId')"><span> 液石法</span>
                        </div>
                        <div class="col-xs-2 no-padding"><input type="radio" id="" name="targetLow" value="targetLow"
                                                                onclick="$.fn.radioButtonSelectionChanged('targetLow', 'targetLowId')"><span> 高圧法</span>
                        </div>
                        <div class="col-xs-3 no-padding"><input type="radio" id="" name="targetLow" value="targetLow"
                                                                onclick="$.fn.radioButtonSelectionChanged('targetLow', 'targetLowId')"><span> ガス事業法</span>
                        </div>

                    </div>
                    <div class="col-xs-1 ml-n-70 border-margin-exp">
                        <p>並び順</p>
                    </div>
                    <div class="col-xs-5 ml-n-30">
                        <div class="col-xs-3 no-padding"><input type="radio" id="" name="sortBy" value="all"
                                                                onclick="$.fn.radioButtonSelectionChanged('sortBy', 'sortById')"><span> 検針順路順</span>
                        </div>
                        <div class="col-xs-2 no-padding"><input type="radio" id="" name="sortBy" value="custom"
                                                                onclick="$.fn.radioButtonSelectionChanged('sortBy', 'sortById')"><span> 検索名順</span>
                        </div>
                        <div class="col-xs-3 no-padding"><input type="radio" id="" name="sortBy" value="custom"
                                                                onclick="$.fn.radioButtonSelectionChanged('sortBy', 'sortById')"><span> 前回実施日順</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 border1 no-padding bottom-box">
                <div class="col-xs-12 no-padding">
                    <p class="back-end">発行消費者</p>
                    <div class="col-xs-7">
                        <table class="table table-bordered">
                            <thead class="bg-color">
                                <th class="col-xs-1"></th>
                                <th class="td-style">適用法令</th>
                                <th class="td-style">消費者コード</th>
                                <th class="td-style">消費者名</th>
                                <th class="td-style">前回実施日</th>
                                <th class="td-style">検針日</th>
                            </thead>
                            <tbody>
                            <tr>
                    ...
                    <div class="col-xs-5">
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-4">
                                <input type="radio" id="" name="consumer_2" value="all"
                                       onclick="$.fn.radioButtonSelectionChanged('consumer_2', 'consumer_2Id')"> 全て
                            </div>
                            <div class="col-xs-4">
                                <input type="radio" id="" name="consumer_2" value="consumer_2"
                                       onclick="$.fn.radioButtonSelectionChanged('consumer_2', 'consumer_2Id')"> 選択以外
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div class="col-xs-4">
                            ...
                            <div class="col-xs-4">
                                <input type="radio" id="" name="date" value="all"
                                       onclick="$.fn.radioButtonSelectionChanged('date', 'dateId')"> 手入力
                            </div>
                            <div class="col-xs-4">
                                <input type="radio" id="" name="date" value="date"
                                       onclick="$.fn.radioButtonSelectionChanged('date', 'dateId')"> 検針日
                            </div>
                        </div>
                        <div class="col-xs-12">
                            <div class="col-xs-4">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="col-xs-8">
                                <div class="col-xs-3 no-padding"><input type="radio" id="" name="consumer" value="all"
                                                                        onclick="$.fn.radioButtonSelectionChanged('consumer', 'consumerId')"><span> 手交</span>
                                </div>
                                <div class="col-xs-3 no-padding"><input type="radio" id="" name="consumer"
                                                                        value="consumer"
                                                                        onclick="$.fn.radioButtonSelectionChanged('consumer', 'consumerId')"><span> 配布</span>
                                </div>
                                <div class="col-xs-3 no-padding"><input type="radio" id="" name="consumer"
                                                                        value="consumer"
                                                                        onclick="$.fn.radioButtonSelectionChanged('consumer', 'consumerId')"><span> 郵送</span>
                                </div>
                                <div class="col-xs-3 no-padding"><input type="radio" id="" name="consumer"
                                                                        value="consumerz"
                                                                        onclick="$.fn.radioButtonSelectionChanged('consumer', 'consumerId')"><span> その他</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12">
