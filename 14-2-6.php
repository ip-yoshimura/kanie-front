            ...
            <form id="meter" action="/gas/meter-reading" method="POST">
                <div class="col-xs-12 no-padding">
                    <div class="form-group">
                        ...
                        <div class="col-xs-1 no-padding">
                            <input type="radio" name="municipality" id="municipality" value="all" onclick="$.fn.radioButtonSelectionChanged('municipality', 'municipalityId')"/> <span> 調整器等</span>
                        </div>
                        <div class="col-xs-1 no-padding">
                            <input type="radio" name="municipality" id="municipality" value="all" onclick="$.fn.radioButtonSelectionChanged('municipality', 'municipalityId')"/> <span> ガスメータ</span>
                        </div>
                        <div class="col-xs-1 no-padding">
                            <input type="radio" name="municipality" id="municipality" value="all" onclick="$.fn.radioButtonSelectionChanged('municipality', 'municipalityId')"/> <span> バルク安全弁</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-8 bottom-box no-padding tbl-scroll">
                    ...
                    <table class="table table-bordered col-xs-12">
                        ...
                        <tr>
                            ...
                            <th class="td-style col-xs-3">型式</th>
