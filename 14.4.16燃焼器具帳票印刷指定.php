            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        ...
                        <input type="radio"/> <span>供給管</span>
                        <input type="radio"/> <span>配管</span>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-xs-1">
                            <input type="radio"/> <span>有</span>
                        </div>

                        <div class="col-xs-1">
                            <input type="radio"/> <span>無</span>
                        </div>

                        <div class="col-xs-2">
                            <input type="radio"/> <span>該当なし</span>
                        </div>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-xs-2">
                            <input type="radio"/> <span>経過年数</span>
                        </div>

                        <div class="col-xs-2">
                            <input type="radio"/> <span>製造年月</span>
                        </div>
                ...
                <div class="col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="col-xs-2">
                            <input type="radio"/> <span>未調査</span>
                        </div>

                        <div class="col-xs-2">
                            <input type="radio"/> <span>不明</span>
                        </div>
    ...
    <div class="col-xs-12 border1 no-padding" style="background-color: white">
        ...
        <div class="col-xs-12">
            <div class="form-group">
                ...
                <div class="col-xs-2">
                    <input type="radio"/> <span>未設置のみ</span>
                </div>
