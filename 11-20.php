                ...
                <div class="col-xs-6 no-padding">
                    <div class="col-xs-12 border1 no-padding">
                        ...
                        <div class="col-xs-12 border-margin-bottom ">
                            ...
                            <div class="col-xs-6 no-padding">
                                <div class="col-xs-12">
                                    <div class="col-xs-4 no-padding"><input type="radio" id="" name=""><span>当月</span></div>
                                    <div class="col-xs-4 no-padding"><input type="radio" id="" name=""><span>翌月</span></div>
                                    <div class="col-xs-4 no-padding"><input type="radio" id="" name=""><span>翌々月</span></div>
                        ...
                        <div class="col-xs-12 border-margin ">
                            ...
                            <div class="col-xs-4 no-padding">
                                <select class="form-control" name="" id="">
                                    <option value="">小数以下切捨て</option>
                                    <option value="">小数以下四捨五入</option>
                                    <option value="">小数以下切上げ</option>
                                    <option value="">1円桁切捨て</option>
                                    <option value="">1円桁四捨五入</option>
                                    <option value="">1円桁切上げ</option>
                                </select>
                            </div>
                        </div>
