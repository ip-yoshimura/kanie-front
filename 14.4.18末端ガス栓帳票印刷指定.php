                    ...
                    <div class="col-xs-12 border1 no-padding">
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-xs-10 no-padding">
                                    ...
                                    <input type="radio"/> <span>未接続末端ガス栓のみ</span>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-3">
                                    <div class="form-group">
                                        <input class="form-control" id="consumerCodeStartName"
                                               name="consumerCodeStartName"
                                               type="text" value=""/>
                                    </div>
                                </div>
                                <div class="col-xs-1 no-padding ratio">~</div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-1">
                                    <div class="form-group">
                                        <input type="radio"/> <span>を含む</span>
                                    </div>
                                </div>
                                <div class="col-xs-1 no-padding">
                                    <div class="form-group">
                                        <input type="radio"/> <span>で始まる</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-xs-1">
                                    <input type="radio"/> <span>しない</span>
                                </div>

                                <div class="col-xs-1">
                                    <input type="radio"/> <span>する</span>
                                </div>
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-xs-2">
                                    <input type="radio"/> <span>指定なし</span>
                                </div>

                                <div class="col-xs-1 no-padding">
                                    <input type="radio"/> <span>年数指定</span>
                                </div>
                    ...
                    <div class="col-xs-12 border1 no-padding bottom-box">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-2 no-padding">
                                            <input type="radio"/> <span>経過集計表</span>
                                        </div>

                                        <div class="col-xs-2 no-padding">
                                            <input type="radio"/> <span>設置集計表</span>
                                        </div>
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-xs-1 no-padding">
                                    <input type="radio"/> <span>営・販</span>
                                </div>
                                ...
                                <div class="col-xs-2">
                                    <input type="radio"/> <span>営業担当</span>
                                </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-2">
                                    <input type="radio"/> <span>設置年月順</span>
                                </div>
