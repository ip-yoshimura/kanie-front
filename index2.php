        ...
        <form action="/gas/meter-reading" id="meter" method="POST">
            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-1  no-padding">
                        <input type="radio" name="custom" value="custom"> 選択
                    </div>
                    <div class="col-xs-1">
                ...
                <div class="col-xs-12">
                    <div class="col-xs-12 no-padding">
                        ...
                        <div class="col-xs-2">
                            <input type="radio" name="salesOutlet" value="salesOutlet"> 検針担当者
                        </div>
                        <div class="col-xs-2">
                            <input type="radio" name="salesOutlet" value="salesOutlet"> 配送委託先
                        </div>
                    </div>
                    <div class="col-xs-12 no-padding">
                        <div class="col-xs-1 col-xs-offset-1">
