            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="col-xs-12">
                    <div class="col-xs-12 no-padding">
                        ...
                        <div class="col-xs-1">
                            <input type="radio" name="entrustSelection" id="entrustSelection" value="all" checked onclick="$.fn.radioButtonSelectionChanged('entrustSelection', 'entrustSelectionId')"> 全て
                        </div>
                        <div class="col-xs-1 no-padding">
                            <input type="radio" name="entrustSelection" id="entrustSelection" value="custom" onclick="$.fn.radioButtonSelectionChanged('entrustSelection', 'entrustSelectionId')"> 直売
                        </div>
                        <div class="col-xs-1 no-padding">
                            <input type="radio" name="entrustSelection" id="entrustSelection" value="custom" onclick="$.fn.radioButtonSelectionChanged('entrustSelection', 'entrustSelectionId')"> 販売店
                        </div>
                    </div>
                    <div id="entrustSelectionId">
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-1 col-xs-offset-2">
                                <div class="form-group">
                                    <input id="trustStartId" name="trustStartId" placeholder="000" class="form-control"
                ...
                <div class="col-xs-12">
                    <div class="col-xs-12 no-padding">
                        ...
                        <div class="col-xs-1">
                            <input type="radio" name="outputSelection" id="outputSelection" value="all" checked onclick="$.fn.radioButtonSelectionChanged('outputSelection', 'outputCategory')"> 全て
                        </div>
                        <div class="col-xs-1 no-padding">
                            <input type="radio" name="outputSelection" id="outputSelection" value="custom" onclick="$.fn.radioButtonSelectionChanged('outputSelection', 'outputCategory')"> 直売
                        </div>
                        <div class="col-xs-1 no-padding">
                            <input type="radio" name="outputSelection" id="outputSelection" value="custom" onclick="$.fn.radioButtonSelectionChanged('outputSelection', 'outputCategory')"> 直売
                        </div>
                    </div>
                    <div id="outputCategory">
                        <div class="col-xs-12 no-padding">
                            <div class="col-xs-1 col-xs-offset-2">
                                <div class="form-group">
                                    <input id="trustStartId" name="trustStartId" placeholder="000" class="form-control"
            ...
            <div class="col-xs-12 border1 no-padding bottom-box">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-7 no-padding">
                        <div class="col-xs-3">
                            <input id="orderBy1" name="orderBy" type="radio" value="orderBy1" /> 消費者コード順
                        </div>
                        <div class="col-xs-3">
                            <input id="orderBy2" name="orderBy" type="radio" value="orderBy2" /> 検索名順
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-7 no-padding">
                        <div class="col-xs-3">
                            <input id="output1" name="outputTarget" type="radio" value="output1" /> 消費者データ
                        </div>
                        <div class="col-xs-3">
                            <input id="output2" name="outputTarget" type="radio" value="output2" /> 保安データ
                        </div>
                    </div>
                </div>
