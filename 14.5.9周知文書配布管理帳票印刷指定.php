                    ...
                    <div class="col-xs-12 border1 no-padding">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-1 no-padding">
                                    <input type="radio"/> <span>一般家庭用</span>
                                </div>
                                <div class="col-xs-1">
                                    <input type="radio"/> <span>業務用</span>
                                </div>
                                <div class="col-xs-1 no-padding">
                                    <input type="radio"/> <span>質量販売用</span>
                                </div>

                                <div class="col-xs-1 no-padding">
                                    <input type="radio"/> <span>外国語用</span>
                                </div>

                                <div class="col-xs-2 no-padding">
                                    <input type="radio"/> <span>工業用（高圧法）</span>
                                </div>

                                <div class="col-xs-2 no-padding">
                                    <input type="radio"/> <span>一般用（ガス事業法）</span>
                                </div>
                    ...
                    <div class="col-xs-12 border1 no-padding bottom-box">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-2">
                                    <input type="radio"/>  <span>次回期限順</span>
                                </div>
