                ...
                <div class="col-xs-12 border1 no-padding">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-xs-1 no-padding"> 部品

                            </label>

                            <div class="col-xs-1">
                                <input type="radio" name="partsSelection" id="partsSelection" value="all" onclick="$.fn.radioButtonSelectionChanged('partsSelection', 'partsSelectionId')"/> <span>ホース</span>
                            </div>


                            <div class="col-xs-1 no-padding">
                                <input type="radio" name="partsSelection" id="partsSelection" value="custom" onclick="$.fn.radioButtonSelectionChanged('partsSelection', 'partsSelectionId')"/> <span>バルブ等</span>
                            </div>

                            <div class="col-xs-2 no-padding">
                                <input type="radio" name="partsSelection" id="partsSelection" value="custom" onclick="$.fn.radioButtonSelectionChanged('partsSelection', 'partsSelectionId')"/><span>中間コック(低圧)</span>
                            </div>
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="col-xs-2">
                                <div class="form-group">
                                    <input id="settingStart" name="settingStart"
                            ...
                            <div class="col-xs-2">
                                <div class="form-group">
                                    <input id="settingEnd" name="settingEnd" class="form-control"
                                    type="date" value=""/>
                                </div>
                            </div>
                        </div>
                ...
                <p class="backend">出力指定</p>
                    ...
                    <div class="col-xs-12">
                        <div class="form-group">
                            ...
                            <div class="col-xs-2">
                                <input type="radio" name="sortBySelection" id="sortBySelection" value="custom" onclick="$.fn.radioButtonSelectionChanged('sortBySelection', 'sortBySelectionId')"/> <span>型式順</span>
                            </div>
