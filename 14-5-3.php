        ...
        <form action="/gas/meter-reading" id="meter" method="POST">
            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="col-xs-12">
                        <div class="form-group">
			    <div class="col-xs-3 no-padding">
                                <label class="col-xs-3 no-padding">対象業務</label>
                                <div class="col-xs-4">
                                    <input type="radio" name="business" id="business" value="all" onclick="$.fn.radioButtonSelectionChanged('business', 'businessId')" /> <span>全て</span>
                                </div>
                                <div class="col-xs-4">
			    ...
			    <div class="col-xs-3 no-padding">
                                <label class="col-xs-3 no-padding">開始</label>
                                <div class="col-xs-4">
                                    <input type="radio" name="business" id="business" value="all" onclick="$.fn.radioButtonSelectionChanged('business', 'businessId')" /> <span>含む</span>
                                </div>
                                <div class="col-xs-4">
                                    <input type="radio" name="business" id="business" value="business" onclick="$.fn.radioButtonSelectionChanged('business', 'businessId')"/> <span>除く</span>
                                </div>
			    </div>
			    <div class="col-xs-3 no-padding">
				<label class="col-xs-3 no-padding">交換</label>
                                <div class="col-xs-4">
                                    <input type="radio" name="business" id="business" value="all" onclick="$.fn.radioButtonSelectionChanged('business', 'businessId')" /> <span>含む</span>
                                </div>
                                <div class="col-xs-4">
                            ...
                            <div class="col-xs-3 no-padding">
                                <label class="col-xs-3 no-padding">供給</label>
                                <div class="col-xs-4">
                                    <input type="radio" name="business" id="business" value="all" onclick="$.fn.radioButtonSelectionChanged('business', 'businessId')" /> <span>含む</span>
                                </div>
                                <div class="col-xs-4">
                ...
                <div class="col-xs-12">
                    <div class="form-group ">
                        ...
                        <label class="col-xs-1 no-padding">次回期限</label>
                        <div class="col-xs-2">
                                <input class="form-control" id="consumerCodeStart" name="consumerCodeStart"
                                       type="date" value=""/>
                        </div>
            ...
            <div class="col-xs-12 border1 no-padding bottom-box">
                ...
                <div class="col-xs-12">
                    <div class="form-group">
			<div class="col-xs-6 no-padding">
                            <label class="col-xs-2 no-padding">並び順1</label>
                            <div class="col-xs-3">
                        ...
                        <div class="col-xs-6 no-padding">
                            <label class="col-xs-2 no-padding">並び順2</label>
                            <div class="col-xs-3">
                                <input type="radio" name="sort1" id="sort1" value="all" onclick="$.fn.radioButtonSelectionChanged('sort1', 'sort1Id')"/> <span>保安業務順</span>
                            </div>
                            <div class="col-xs-3">
                                <input type="radio" name="sort1" id="sort1" value="sort1" onclick="$.fn.radioButtonSelectionChanged('sort1', 'sort1Id')"/> <span>調査日順</span>
                            </div>
                        </div>
                    </div>
                </div>
