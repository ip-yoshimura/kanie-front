                ...
                <div class="col-xs-12 border1 no-padding">
                    ...
                    <div class="col-xs-12">
                        <div class="no-padding">
                            ...
                            <div class="col-xs-1">
                                <input type="radio" name="fingersSelection" id="fingersSelection" value="custom" onclick="$.fn.radioButtonSelectionChanged('fingersSelection', 'fingersSelectionId')"><span> 指定</span>
                            </div>
