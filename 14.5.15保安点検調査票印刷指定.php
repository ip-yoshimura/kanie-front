                    ...
                    <div class="col-xs-12 border1 no-padding">
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-12 no-padding">
                                ...
                                <div class="col-xs-2 no-padding">
                                    <input name="directSales" type="radio" value="directSales"><span>保安機関（前回実施者）</span>
                                </div>

                                <div class="col-xs-3">
                                    <input name="directSales" type="radio" value="directSales"> <span>保安機関（供給設備点検実施者）</span>
                                </div>
                        ...
                        <div class="col-xs-12">
                            <div class="col-xs-12 no-padding">
                                ...
                                <div class="col-xs-2">
                                    <input name="directSales" type="radio" value="directSales"><span>シリンダ</span> 


                                </div>
                                <div class="col-xs-2">
                                    <input name="directSales" type="radio" value="directSales"><span>バルク</span> 
                    ...
                    <div class="col-xs-12 border1 no-padding bottom-box">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-2 no-padding">
                                    <input type="radio"/><span>結果集計表</span> 
                                </div>

                                <div class="col-xs-2 no-padding">
                                    <input type="radio"/><span>次回期限集計表</span> 
                                </div>

                                <div class="col-xs-2 no-padding">
                                    <input type="radio"/><span>最新一覧表</span> 
                                </div>
