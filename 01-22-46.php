        ...
        <form id="meter" action="/gas/meter-reading" method="POST">
            <div class="col-xs-12 no-padding">
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="col-xs-3">
                        <div class="form-group">
                            <input id="trustEndId" name="trustEndId" class="form-control"
                                   type="text" value=""/>
                        </div>
                    </div>
            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="col-xs-12">
                    ...
                    <label class="col-xs-2 no-padding ml-70 border-margin-exp">最新メータ交換情報 </label>
                    <label class="col-xs-1 no-padding ml-n-40 border-margin-exp">交換日 </label>
            ...
            <div class="col-xs-12 border1 no-padding bottom-box">
                ...
                <div class="col-xs-12 border-margin">
                    ...
                    <div class="col-xs-1 no-padding col-xs-offset-1 border-margin-exp">
                        <p>設定区分</p>
                    </div>
                    <div class="col-xs-1 ml-30">
                        <input type="number" class="form-control" placeholder="0.0">
                    </div>
                    <div class="col-xs-2">
                ...
                <div class="col-xs-12 border-margin">
                    ...
                    <div class="col-xs-2 no-padding col-xs-offset-2 border-margin-exp">
                        <p>警報機との接続状況</p>
                    </div>
                    <div class="col-xs-4 ml-n-60">
                ...
                <div class="col-xs-12 border-margin">
                    ...
                    <div class="col-xs-3">
                        ...
                        <div class="col-xs-2 no-padding"><input type="radio" id="" name=""><span> 右</span>
                        </div>
                    </div>
