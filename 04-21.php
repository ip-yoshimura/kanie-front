    ...
    <div class="col-md-12 col-xs-12 body-background no-padding">
        ...
        <form id="meter" action="/gas/meter-reading" method="POST">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-12 no-padding">
                        <div class="col-xs-12 no-padding">
                            ...
                            <div class="col-xs-1 no-padding ml-30">
                                <input type="radio" name="trust1Selection" id="trust1Selection" value="custom"
                                       onclick="$.fn.radioButtonSelectionChanged('trust1Selection', 'trust1SelectionId')">
                                <span>販売店</span>
                            </div>
            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="col-xs-12">
                    <label class=" col-xs-2 no-padding">作成日付</label>
                    <div class="col-xs-2">
                        <input type="date" class="form-control"/>
                    </div>
                </div>
                <div class="col-xs-12 border-margin">
                    <label class="col-xs-2 no-padding">締切日</label>
                    <div class="col-xs-1">
                    ...
                    <div class="no-padding">
                        ...
                        <div class="col-xs-1 no-padding">
                            <input type="radio" name="category" id="category" value="custom"
                                   onclick="$.fn.radioButtonSelectionChanged('category', 'categoryId')"><span> 含まない</span>
                        </div>
                ...
                <div class="col-xs-12 border-margin  no-padding">
                    <div class="col-xs-2 no-padding">
                        <p style="margin-left: 40px">(コンビニ)</p>
                    </div>
                ...
                <div class="col-xs-12 border-margin  no-padding">
                    <div class="col-xs-2 no-padding">
                        <p style="margin-left: 30px">(クレジット)</p>
                    </div>
                ...
                <div class="col-xs-12 border1 no-padding">
                    ...
                    <div class="col-xs-12  ">
                        <div class="no-padding">
                            ...
                            <div class="col-xs-2 no-padding ml-n-60">
                                <input type="radio" name="pageBreak" id="pageBreak" value="custom"
                    ...
                    <div class="col-xs-12  ">
                        <div class="no-padding">
                            ...
                            <div class="col-xs-2 no-padding ml-30">
                                <input type="radio" name="sortBy" id="sortBy" value="custom"
                                       onclick="$.fn.radioButtonSelectionChanged('sortBy', 'sortById')">
                                <span>集金順路順</span>
                            </div>
