                ...
                <form action="/gas/meter-reading" id="meter" method="POST">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="col-xs-1 no-padding"> 印刷区分指定
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="col-xs-1 no-padding col-xs-offset-1">営業所コード</label>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="form-group">
                            <label class="col-xs-1 no-padding col-xs-offset-1">販売店指定
