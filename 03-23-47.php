        ...
        <form action="/gas/meter-reading" id="meter" method="POST">
            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-2 no-padding ml-n-50">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-1">
                        <input name="NoUseCustomer" type="radio" value="all" checked onclick="$.fn.radioButtonSelectionChanged('segment', 'segmentId')"> <span> 出力する</span>
                    </div>
                    <div class="col-xs-2">
                        <input name="NoUseCustomer" type="radio" value="directSales" onclick="$.fn.radioButtonSelectionChanged('segment', 'segmentId')"> <span> 出力しない</span>
                    </div>
                </div>
            ...
            <div class="col-xs-12 border1 no-padding bottom-box">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="col-xs-2 no-padding">
                        <input name="SortBy" type="radio" value="all" onclick="$.fn.radioButtonSelectionChanged('SortBy', 'SortById')"> <span> 営業所・販売店</span>
                    </div>
                    <div class="col-xs-2 no-padding">
                        <input name="SortBy" type="radio" value="directSales" onclick="$.fn.radioButtonSelectionChanged('SortBy', 'SortById')"> <span> なし</span>
                    </div>
                </div>
