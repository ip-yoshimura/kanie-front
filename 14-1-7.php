...
<div id="lableId">
            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="col-xs-12 border-margin-bottom no-padding">
                    <div class="col-xs-1">
                        <p>対象業務</p>
                    </div>
                    <div class="col-xs-2">
                        <div class="col-xs-6 no-padding"><input type="radio" id="" name="business" value="all"
                                                                onclick="$.fn.radioButtonSelectionChanged('business', 'businessId')"><span> 全て</span>
                        </div>
                        <div class="col-xs-6 no-padding"><input type="radio" id="" name="business" value="business"
                                                                onclick="$.fn.radioButtonSelectionChanged('business', 'businessId')"><span> 選択</span>
                        </div>
                    </div>
			...
			<div class="col-xs-3 no-padding">
                            ...
                            <div class="col-xs-7 no-padding">
                                ...
                                <div class="col-xs-6 no-padding"><input type="radio" id="" name="business" value="business"
                                                                onclick="$.fn.radioButtonSelectionChanged('business', 'businessId')"><span> 除く</span>
                                </div>
                            </div>
			</div>
