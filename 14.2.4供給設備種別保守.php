        ...
        <div class="head-p">
            <p>供給設備種別保守
                ...
                <form action="/gas/meter-reading" id="meter" method="POST">
                    <div class="col-xs-12">
                    <label class="col-xs-2" style="color: black">供給設備区分</label>
                    <div class="form-group col-xs-6">

                        <input type="radio" name="Supply" id="Supply" value="all" onclick="$.fn.radioButtonSelectionChanged('Supply', 'SupplyId')"/> <span>供給管</span>

                        <input type="radio" name="Supply" id="Supply" value="Supply" onclick="$.fn.radioButtonSelectionChanged('Supply', 'SupplyId')"/> <span>調整器等</span>

                        <input type="radio" name="Supply" id="Supply" value="Supply" onclick="$.fn.radioButtonSelectionChanged('Supply', 'SupplyId')"/> <span>ガスメータ</span>
