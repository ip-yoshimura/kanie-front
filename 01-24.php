            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="col-xs-12">
                    <div class="col-xs-12 no-padding">
                        ...
                        <div class="col-xs-1 no-padding ml-15">
                            <input type="radio" name="trustClassificationSelection1" value="delievry"
                                   onclick="$.fn.radioButtonSelectionChanged('trustClassificationSelection1', 'trustClassificationSelection1Form')">
                            <span> 配送担当者</span>
                        </div>
                ...
                <div class="col-xs-12">
                    ...
                    <div id="consumerCodeForm">
                        ...
                        <div class="col-xs-2">
                            <div class="form-group">
                                <input id="meterReadingRouteStartName" name="meterReadingRouteStartName" placeholder="0"
                                       class="form-control"
                                       type="number" value=""/>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-xs-3">
                            <select name="" class="selclass form-control">
                                <option value="ガスメーター取替のお">ガスメーター取替</option>
