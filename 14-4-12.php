            ...
            <div class="col-xs-12 border1 no-padding">
                ...
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-xs-1 no-padding"> 接続区分
                        ...
                        <div class="col-xs-10">
                            ...
                            <input type="radio" name="distinguish" id="distinguish" value="distinguish" onclick="$.fn.radioButtonSelectionChanged('distinguish', 'distinguishId')"/> <span>接続</span>
                            <input type="radio" name="distinguish" id="distinguish" value="distinguish" onclick="$.fn.radioButtonSelectionChanged('distinguish', 'distinguishId')"/> <span>未接続</span>
                            <input type="radio" name="distinguish" id="distinguish" value="distinguish" onclick="$.fn.radioButtonSelectionChanged('distinguish', 'distinguishId')"/> <span>休止中</span>
