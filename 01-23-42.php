            ...
            <form id="meter" action="/gas/meter-reading" method="POST">
                ...
                <div class="col-xs-12 no-padding ">
                    ...
                    <div class="col-xs-12  ">
                        ...
                        <div class="col-xs-1  "><input id="meterSelection" name="meterSelection"
                                                       type="radio"
                                                       value="手書伝票"
                                                       onclick="$.fn.radioButtonSelectionChanged('meterSelection', 'meterSelectionId')"/>
                            <span>全て</span>
                        </div>
                        ...
                        <div class="col-xs-1"><input id="meterSelection" class="form-control text-right"
                                                     name="meterSelection" type="text" value="日"/></div>
                ...
                <div class="col-xs-12 no-padding">
                    ...
                    <div class="col-xs-12  ">
                        ...
                        <div class="col-xs-2  "><input id="meterReadingClassification1"
                                                       name="meterReadingClassification"
                                                       type="radio"
                                                       value="手書伝票"/> <span> 逆針のみ</span>
                        </div>
                        <div class="col-xs-2 no-padding ml-n-90"><input id="meterReadingClassification2"
                                                                name="meterReadingClassification" type="radio"
                                                                value="ハンディ"/> <span> 未検針のみ</span>
                        </div>
                        <div class="col-xs-1 no-padding ml-n-80"><input id="meterReadingClassification2"
                                                                name="meterReadingClassification" type="radio"
