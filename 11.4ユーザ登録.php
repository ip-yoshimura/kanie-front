                ...
                <div class="col-xs-12 border1 no-padding">
                    ...
                    <div class="col-xs-12 border-margin">
                        ...
                        <div class="col-xs-10 no-padding">
                            ...
                            <div class="col-xs-2 no-padding"><input type="radio" id="" name="authority"
                                                                    value="authority"
                            ...
                            <div class="col-xs-2 no-padding"><input type="radio" id="" name="restriction"
                                                                    value="restriction"
                    ...
                    <div class="col-xs-12 border-margin">
                        ...
                        <div class="col-xs-10 no-padding">
                            <div class="col-xs-2 no-padding"><input type="radio" id="" name="restriction" value="all"
