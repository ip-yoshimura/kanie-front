                    ...
                    <div class="col-xs-12 border1 no-padding">
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-2">
                                    <div class="form-group">
                                        <input class="form-control" id="classificationEnd" name="classificationEnd"
                                               placeholder="z"
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-group">
                              ...
                              <div id="manufacturerId">
                                ...
                                <div class="col-xs-2">
                                    <div class="form-group">
                                        <input class="form-control" id="manufacturerEnd" name="manufacturerEnd"
                                               placeholder="z"
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                <label class="col-xs-1 no-padding"> 大小文字判別
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <label class="col-xs-2 control-label"> 年数不明
                                </label>
                                ...
                                <div class="col-xs-2">
                                    <div class="form-group">
                                        <input class="form-control" id="consumer_2CodeStart" name="consumer_2CodeStart"
                                               placeholder="0" type="text" value="" onchange="$.fn.onInputValueChange('consumer_2CodeStart', 'consumer_2Name')"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-2">
                                    <div class="form-group">
                                        <input class="form-control" id="consume_3CodeStart" name="consume_3CodeStart"
                                               placeholder="0" type="text" value="" onchange="$.fn.onInputValueChange('consume_3CodeStart', 'consum_3End')"/>
                                    </div>
                                </div>
                                <div class="col-xs-1 no-padding ratio">~</div>
                                <div class="col-xs-2">
                    ...
                    <div class="col-xs-12 border1 no-padding bottom-box">
                        ...
                        <div class="col-xs-12">
                            <div class="form-group">
                                ...
                                <div class="col-xs-1 no-padding">
                                    <input type="radio" name="pageBreak" value="all" onclick="$.fn.radioButtonSelectionChanged('pageBreak', 'pageBreakId')"/> <span>営・販</span>
                                </div>
                                ...
                                <div class="col-xs-2">
                                    <input type="radio" name="pageBreak" value="pageBreak" onclick="$.fn.radioButtonSelectionChanged('pageBreak', 'pageBreakId')"/> <span>営業担当</span>
                                </div>
